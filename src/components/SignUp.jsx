        ...
        <div className="w-[478px] px-8 border gap-6 border-gray-200 rounded-[10px] py-14 md:p-8">
          <div className="text-center">
            <h2 className="flex items-center justify-center text-xl font-bold md:text-2xl">
              Welcome <img src='/registration/hand.png' alt='hand' width={24} height={24} />
            </h2>
          ...
          <form onSubmit={handleSignup} className="">
            {/* Name Field */}
            <div className='flex items-center justify-center mb-3 gap-[10px]'>
              <div className="">
          ...
          <div className="">
            ...
            <div className="flex space-x-3 mt-2 md:mt-3">
              <button className="flex items-center justify-center w-full rounded-[60px] border-[1px] py-2 gap-3">
                <FcGoogle size={20} /> <span className='text-sm font-normal'>Login with Google</span>
              </button>
              <button className="flex items-center justify-center w-full rounded-[60px] border-[1px] py-2 gap-3">
          ...
          <p className="mt-6 text-xs text-center text-black md:text-base font-normal">
            I don’t have an account? <a href="/sign-in" className="text-[#00E0D2]">Sign In</a>
          </p>
        </div>
      </div>
